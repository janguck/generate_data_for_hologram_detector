...
class HoloDetector:
    ...
    def calc_holo_points(self):
        ...
        self.holo_mask[tuple(zip(*filtered_points))] = (0, 0, 255)
    ...
    def detect_rect(self, gray):
        ...
        for c1, c2, c3, c4 in combs:
            angles = [angle(c1 - c2, c3 - c2),
                      angle(c2 - c3, c4 - c3),
                      angle(c1 - c4, c3 - c4)]
            if np.allclose(angles, np.pi / 2, rtol=0.27):
    ...
    def detect_holos(self, img):
        ...
        if self.is_training:
            ...
            return holo_mask_t, img_holo, fs_mask_warped
        return holo_mask_t, img_holo, None
